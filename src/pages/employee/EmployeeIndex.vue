<template>
  <div>
    <el-row>
      <el-button type="primary" size="small" @click="openEmployeeInfo(1)">新建2</el-button>
...
export default {
  ...
  methods: {
    ...
    openEmployeeInfo(addOrUpdate, sid) {
      this.$pubsub.publish("getEmployee", { sid, addOrUpdate });

      this.$store.dispatch("employee/openInfo", { addOrUpdate });
    },
